...
const output = path.join(process.cwd(), "public", "reports", "ma-yen-chen-hon-hai-investment-case.pdf");
...
try {
  ...
  await page.goto("http://127.0.0.1:4176/reports/honhai/", { waitUntil: "networkidle" });
  await page.pdf({
    path: output,
    format: "A4",
