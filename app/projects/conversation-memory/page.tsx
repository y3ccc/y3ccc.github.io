...
export const metadata: Metadata = {
  ...
  description:
    "每次重開對話，我都得回想上次談到哪裡，還要重新交代背景。這個案例記錄我怎麼減少重工。",
  openGraph: {
    title: "馬彥宸｜每次開新對話，都在考我",
    description: "把「記住上次講到哪」的負擔從人身上移走。含 29 張可展開的伺服器地圖，以及 13 項已停用服務的死因。",
    ...
    <>
      ...
      <main className="shell">
        ...
        <p className="lede">
          ...
          結果又重新討論了一次。後來我把問題拆成兩部分：找回上次進度，
          以及減少每次重打相同規則。
        </p>

        <CaseSummary
          problem="額度用完、隔幾天回來，已經不記得是哪個對話，結果又把同一件事重新討論一次。"
          decision="記憶只保存查證方式，不直接保存可能過期的結論；重複規則則寫進固定文件。"
          check="舊討論索引只提醒「這個以前討論過」，是否沿用仍由我決定，避免直接套用過期方案。"
        ...
        <section className="band">
          <h2>我做的兩項調整</h2>
          <p>
            <strong>自動整理變更</strong>：讓機器列出「上次之後發生了什麼」，減少靠記憶回想。
            另外做了一個舊討論的索引，遇到類似主題會先提醒我「這個以前討論過」；
            但它只能提醒，要不要沿用是我決定的，不然它又會拿一個過期的方案給我。
          </p>
          <p>
            <strong>固定共用規則</strong>：把每次都在重打的規則寫成固定檔案。
        ...
        <section className="band">
          ...
          <div className="demo">
            <div className="demo-head">
              <h3>我的伺服器地圖</h3>
              <p>展示版　·　內容整理自「我宣告要有什麼」與「機器實際有什麼」的比對結果；這一頁是當時的靜態快照，不會自己更新</p>
            </div>
            ...
            <div className="demo-foot">
              ...
              <p>
                ...
                因為這頁只是一張快照，內容可能已經過期；實際狀態仍要回到機器查證。
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="band">
          ...
          <Rhythm
            bands={[
              ...
              { from: 12, to: 24, k: "沒有排定的工作", s: "只剩磁碟、心跳與筆記同步在背景跑，不會來找我", c: 0 },
            ]}
        ...
        <section className="band">
          ...
          <div className="honest">
            ...
            <p>
              ...
              找舊對話需要更好的索引，更好的索引可能要跑嵌入，也會增加成本。
              <strong>目前仍未找到成本與搜尋效果都合適的方案。</strong>
            </p>
          </div>
        </section>
