...
const limits = [
  ...
  "記憶那套我實際去查過一次（2026 年 8 月）：24 天內累積 500 多筆討論紀錄、530 個不重複主題，約半數有明確處置，其中 58 筆標記為已否決或被取代。這證明我真的在用它決定「這個以前討論過，要不要沿用」，但不證明它省下時間——我沒有前後對照，也沒有基準線。",
  "伺服器上比較細的服務設定與流程，我沒辦法憑記憶重現。這正是我把它們寫成紀錄的原因——18 份服務清冊、143 次版本紀錄、一份可重新生成的全景圖。要從零重做，我翻紀錄，不靠回想。",
];
